...
java -cp $classpath -Djava.library.path=$solclientlib com.solacesystems.demo.MockMatchingEngine \
	msgvpn-3419.messaging.datago.io:20128 app1 1 msgvpn-3419 datago-client-username 72f9nie8jpfdaj8gjse23vr21t \
	order/new active_matcher/app1/inst2/\> active_matcher/app1/inst1/new standby_matcher/app1/inst1/new
